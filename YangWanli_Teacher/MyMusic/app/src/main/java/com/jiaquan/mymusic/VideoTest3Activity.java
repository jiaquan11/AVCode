...
public class VideoTest3Activity extends AppCompatActivity {
    ...
    private MyGLSurfaceViw mMyGLSurfaceViw_ = null;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMyGLSurfaceViw_ = findViewById(R.id.myGlSurfaceView);
        mMyGLSurfaceViw_.setOnSurfaceListener(new MyGLSurfaceViw.OnSurfaceListener() {
            @Override
