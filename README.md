...
问题点汇总处理
1、双缓冲区方式录制有电流杂音  true
   
九、LivePusher项目
摄像头画面方向纠正，摄像头画面编码为MP4视频
摄像头画面和其他音乐合成新的视频，摄像头数据和麦克风音频数据推流到直播服务器实现直播功能
问题点汇总处理
1、摄像头预览横竖屏切换会短暂黑屏半截的问题  true
2、摄像头竖屏预览前后切换的时候，会短暂先倒立画面，然后恢复正常，
   横屏预览前后切换的时候，会短暂出现左右镜像，然后恢复正常        true
3、图片合成视频，第一遍预览合成后，再次点击预览合成，会出现预览黑屏   false
